...
$rest_uri = 'http://testmd8ddev/es/views/wea';
...
foreach ($decoded_results as $decoded_result) {
  echo "<ul>";
  echo "<li>Titulo: " . $decoded_result->wea_title . "</li>";
  echo "<li>Coordenadas: " . $decoded_result->wea_coordinates . "</li>";
  echo "<li>Descripcion: " . $decoded_result->wea_description . "</li>";
  echo "</ul>";
}
?>
  </body>
