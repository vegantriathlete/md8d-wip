...
$rest_uri = 'http://testmd8ddev/es/wea/actions/22?_format=json';
...
<?php
  echo "<ul>";
  echo "<li>Titulo: " . $decoded_results->title . "</li>";
  echo "<li>Coordenadas: " . $decoded_results->coordinates . "</li>";
  echo "<li>Descripcion: " . $decoded_results->description . "</li>";
  echo "</ul>";
?>
  </body>
</html>
